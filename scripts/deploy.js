...
async function main() {
  ...
  console.log(`🔴 VITE_SC01_IMPROPER_ACCESS_CONTROL_VULNERABLE_ADDRESS='${sc01_vulnerable.target}'`);
  updateEnvFile("VITE_SC01_IMPROPER_ACCESS_CONTROL_VULNERABLE_ADDRESS", `'${sc01_vulnerable.target}'`);
  ...
  updateEnvFile("VITE_SC01_IMPROPER_ACCESS_CONTROL_FIXED_ADDRESS", `'${sc01_fixed.target}'`);
}
